...
class Flight(TimeStampedModel):
    ...
    weight = models.DecimalField(max_digits=10, decimal_places=3, verbose_name=_('weight'), null=True, blank=True)
    ...
    consumption = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_('consumption'), null=True,
                                      blank=True)
...
class BaseParcel(TimeStampedModel):
    ...
    code = models.CharField(db_index=True, max_length=64, verbose_name=_('Код'))
    track_code = models.CharField(db_index=True, max_length=64, verbose_name=_('Трек-Код'))
    weight = models.DecimalField(max_digits=10, decimal_places=3, verbose_name=_('weight'))

    # Габариты
    width = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_('width'))
    length = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_('length'))
    height = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_('height'))
